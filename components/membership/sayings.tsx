...
const Sayings = () => {
    return (
        <main className="border border-r-0 border-t-0 border-l-0 border-black">
            <div className="mobile_center lg:flex gap-[105px] lg:py-28 py-16 lg:space-y-0 space-y-14">
                <p className=" lg:text-5xl text-4xl ">What members <br /> are saying</p>
                    ...
                    {data?.map((item, Index) => (
                        <section key={Index} className="lg:flex lg:items-start lg:justify-center gap-5 lg:space-y-0 space-y-5 ">
                            ...
                            <div>
                                ...
                                <p className=" mb-3 text-gray-800 md:text-xl text-lg">{item.sayings}</p>
