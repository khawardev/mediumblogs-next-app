...
export default function Component({ noOfComments, username, userImage }: props) {
    ...
    return (
        <Sheet>
            ...
            <SheetContent side="right" className="overflow-y-auto sohne md:w-[400px] w-[360px] bg-background shadow-lg">
                    ...
                    <div className=" space-y-6 py-4  ">
                        <section className="border rounded-lg p-3 ">
                            <section className="flex items-center gap-4">
                                ...
                                {/* {username} */}
                                <section>
                                    <div className="font-bold sohne_bold">Khawar</div>
