                ...
                <section className="flex space-x-5">
                    ...
                    {comment?.reply?.length > 0 &&
                        <button className='flex-center gap-1' onClick={() => setShowReplyComments(!showReplyComments)}>
                            ...
                            <p className="text-sm text-slate-400">{comment?.reply?.length} Replies</p>
                        </button>
                    }
                </section>
                <button onClick={() => setShowReplyArea(!showReplyArea)} className=" font-bold text-sm text-slate-400" >Reply</button>
            </section>
            <section>
