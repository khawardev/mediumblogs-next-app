    ...
    return (
        <div id="container" className="max-w-6xl mx-auto relative font-mono mt-8">
            ...
            >
                ...
                <div
                    className={`flex items-center space-x-4 absolute top-0 left-14 ${tools ? "visible" : "invisible"
                        }`}
                >
                    <span
                        onClick={InsertImage}
                        className={`border-[1.5px] border-green-500 rounded-full block p-2 ${tools ? "scale-100 visible" : "scale-0 invisible"
