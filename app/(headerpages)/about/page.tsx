            ...
            <section className="bg_dots">
                <section className="mobile_center">
                    <section className="space-y-10 md:py-32 py-20  xl:w-1/2 lg:w-[60%] text-white">
                        ...
                        <p className=" text-yellow-400  lg:text-2xl text-xl">Ultimately, our goal is to deepen our collective understanding of the world through the power of writing.</p>
