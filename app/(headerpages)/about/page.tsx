            ...
            <section className="bg_dots">
                <section className="mobile_center">
                    <section className="space-y-10 md:py-32 py-20  xl:w-1/2 lg:w-[60%] text-white">
                        ...
                        <p className="leading-7 sohne_bold lg:text-3xl text-2xl -z-10 highlight highlight-yellow-400 highlight-spread-x-sm highlight-variant-1">Ultimately, our goal is to deepen our collective understanding of the world through the power of writing.</p>
